...
fun russian(n: Int): String {
    ...
    val n5 = mapOf(
        0 to "", 1000 to " тысяча", 2000 to " две тысячи", 3000 to " три тысячи", 4000 to " четыре тысячи",
    ...
    //
        ...
        if (n / 1000 % 10 == 0) {
            ...
            (n8[100000 * (n / 100000)] + n3[10 * ((n / 10000) % 10)] + n5[1000 * ((n / 1000) % 10)] + n4[100 * ((n / 100) % 10)]
                    + n3[10 * (n % 100 / 10)] + n1[n % 10]).removeRange(0, 1)
        }
    }
    //
        ...
        (n8[100000 * (n / 100000)] + n6[1000 * ((n / 1000) % 100)]
                + n4[100 * ((n / 100) % 10)]
                + n3[10 * (n % 100 / 10)] + n1[n % 10]).removeRange(0, 1)
    else return (n8[100000 * (n / 100000)] + n3[10 * ((n / 10000) % 10)]
            + n6[10000 * ((n / 1000) % 100)]
            + n4[100 * ((n / 100) % 10)]).removeRange(0, 1)
}