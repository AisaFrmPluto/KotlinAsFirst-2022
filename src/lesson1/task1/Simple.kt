 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial + (3 * (percent / 100) * initial)).toDouble()
 ...
 */
fun numberRevert(number: Int) = ((number % 100) % 10) * 100 + ((number % 100) / 10) * 10 + (number / 100)
