...
class Tests {
    ...
    fun mean() {
        ...
        assertEquals(0.5, mean(listOf(0.0, 1.0)), 1e-5)
    }
    ...
    fun russian() {
        ...
        assertEquals("четыреста пятьдесят одна тысяча пятьсот восемьдесят четыре", russian(451584))
        assertEquals("девятьсот тринадцать тысяч шестьсот пятьдесят", russian(913650))
        assertEquals("семьсот тысяч восемьсот одиннадцать", russian(700811))
        assertEquals("сто пятнадцать тысяч пятьсот одиннадцать", russian(115511))
    }
}