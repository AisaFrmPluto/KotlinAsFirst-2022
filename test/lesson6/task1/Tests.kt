...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("января"))
        assertEquals("01.01.13282", dateStrToDigit("01 января 13282"))
    }
    ...
    fun bestLongJump() {
        ...
        assertEquals(121, bestLongJump("121"))
        assertEquals(-1, bestLongJump("706-9 5"))
    }
